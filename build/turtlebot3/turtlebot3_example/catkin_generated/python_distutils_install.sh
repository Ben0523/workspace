...
echo_and_run cd "/workspace/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/workspace/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/workspace/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
