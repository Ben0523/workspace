...
echo_and_run cd "/workspace/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/workspace/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/workspace/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
