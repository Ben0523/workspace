...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/darknet_ros/darknet_ros/include;/usr/include".split(';') if "/workspace/src/darknet_ros/darknet_ros/include;/usr/include" != "" else []
