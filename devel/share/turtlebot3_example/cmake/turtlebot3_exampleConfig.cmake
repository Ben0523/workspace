...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_example_SOURCE_PREFIX /workspace/src/turtlebot3/turtlebot3_example)
  set(turtlebot3_example_DEVEL_PREFIX /workspace/devel)
  ...
  set(turtlebot3_example_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/turtlebot3/turtlebot3_example/${idir}'.  ${_report}")
    endif()
